    ...
    public function run(): void
    {
        DeficiencyLevel::create([
            ...
            'meaning' => '
                ...
                muy significativas, o la eficacia del conjunto de medidas preventivas existentes respecto al riesgo
        ...
        DeficiencyLevel::create([
            ...
            'value' => '6',
            'meaning' => '
                Se ha(n) detectada algún(os) peligro(s) que pueden dar lugar a consecuencias significativa(s), o la
                eficacia del conjunto de medidas preventivas existentes es baja, o ambas.
            ',
            'color' => '#FD8D14'
        ]);
