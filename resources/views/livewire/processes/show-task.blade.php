<div>
    <button wire:click="$set('open', true)" class="bg-green-600 text-gray-100 py-1 px-2 rounded-full text-md">Ver tareas</button>

    <x-dialog-modal wire:model="open">
        <x-slot name="content">
            <h1 class="bg-green-600 p-1 mt-2 mb-4 font-semibold text-2xl rounded-lg w-4/5 mx-auto text-center text-gray-100">Tareas - </h1>
                ...
                <tbody class="bg-white text-gray-600 text-sm font-light">
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="text-center">
                            <button
                                class="bg-green-600 text-gray-100 py-1 px-2 rounded-full text-md">Ver tareas</button>
                        </td>
                    </tr>
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
