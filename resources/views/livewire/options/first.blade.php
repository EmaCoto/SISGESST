{{-- Be like water. --}}
    <div class="w-6/12 p-4">
        ...
        <div class="flex">
            <select wire:model="deficiency" class="block cursor-pointer bg-gray-100 border focus:bg-white border-gray-300 rounded-lg mt-2 border-b border-t focus:border-t focus:border-b focus:border-0 shadow-lg focus:border-green-500 focus:ring-0 focus:outline-none">
