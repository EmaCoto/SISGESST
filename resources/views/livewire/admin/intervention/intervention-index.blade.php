        ...
        <div id="contentEval"
            ...
            <div class="w-11/12 mx-auto mt-6">
                <div class="relative flex md:block bg-gray-500 text-center rounded-t-md font-bold text-lg text-gray-100 py-2">
                    <div class="ml-2 md:ml-0 w-2/3 md:w-full">Eliminacion</div>
            ...
            <x-danger-table>
                <x-slot name="titleOne">
                    <div class="ml-2 md:ml-0 w-2/3 md:w-full">Controles de ingenieria</div>
                ...
                <x-slot name="titleTwo">
                    <div class="ml-2 md:ml-0 w-2/3 md:w-full">Sustitucion</div>
