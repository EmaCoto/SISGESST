            ...
            <div class="w-[78vw] mx-auto flex gap-6 my-10">
                <div class="w-full text-center">
                    ...
                    <div class="grid grid-cols-12 font-semibold">
                        ...
                        <div class="flex items-center justify-center col-span-2 bg-gray-400 text-gray-100 p-1">Valor de
                            ND</div>
                        <div class="flex items-center justify-center col-span-8 bg-gray-400 text-gray-100 p-1">
                            Significado</div>
                    </div>
                    @foreach ($deficiencies as $deficiency)
                        <div class="grid grid-cols-12 text-left">
                            <div class="col-span-2 flex items-center justify-center px-2 py-1 border-b-2 border-l-2 border-gray-400 font-medium"
