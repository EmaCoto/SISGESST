<div class="flex flex-col">
    <main class="flex-grow flex">
        ...
        <div id="contentEval" class="relative px-20 py-6 w-[85vw] h-[93.9vh] overflow-y-scroll overflow-x-hidden bg-gray-200 ">
            <h1 class="text-center mb-10 text-3xl font-semibold text-gray-400 border-b-2 border-gray-400 w-48 mx-auto">Evaluadores</h1>
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-center">
                                <div class="flex item-center justify-center">
                                    ...
                                    <button wire:click="confirmDelete({{ $evaluator->id }})"
