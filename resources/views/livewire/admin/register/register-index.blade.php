    ...
    <main class="flex-grow flex">
        ...
        <div id="contentEval" class="relative px-4 py-2 w-[85vw] h-[93.9vh] overflow-y-scroll overflow-x-hidden bg-gray-200 ">
            <form wire:submit.prevent="registerUser" class="flex h-full items-center">
                <div class="lg:w-1/2 md:m-auto md:rounded-lg bg-white md:shadow-lg">
                    ...
                    <div class="w-full flex justify-center">
                        <button type="submit" class="bg-green-600 rounded-lg  p-2 text-white m-4 w-1/4 text-xl mt-20">Registrar Usuario</button>
                    </div>
                </div>
            </form>
        </div>
