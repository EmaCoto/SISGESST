<div>
    <div class="border-2 border-gray-500 mb-8">
        ...
        <div class="text-center font-bold w-full grid grid-cols-12">
            <div class="col-span-3 w-full bg-gray-300 border-r-2 border-b-2 p-2 border-gray-500">
                Medida
            </div>
            <div class="col-span-4 w-full bg-gray-300 border-r-2 border-b-2 p-2 border-gray-500">
                Descripcion
            </div>
            <div class="col-span-5 w-full bg-gray-300 border-r-2 border-b-2 p-2 border-gray-500">
                Sugerencia
            </div>
        </div>
    ...
    <div class="border-2 border-gray-500 mb-8">
        <div class="text-left w-full grid grid-cols-2">
            <div
                class="w-full bg-gray-300 border-r-2 p-2 border-gray-500 flex items-center">
