        ...
        <article>
            ...
            <div class="grid md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 gap-4 m-auto p-3">
                <div>
                    ...
                    <x-measures-elimination wire:model="elimination" />
                </div>
                ...
                <div>
                    ...
                    <x-measures-substitution wire:model="substitution" />
                </div>
                <div>
                    <h2 class="text-lg font-bold bg-gray-300 w-full pl-4 pr-2 pt-1 rounded-t-md flex justify-between">
                    ...
                    <x-measures-engineering wire:model="engineeringControls" />
                </div>
            </div>
            <div class="grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 gap-4 m-auto p-2">
                <div>
                    ...
                    <x-measures-administrative wire:model="administrativeControls" />
                </div>
                <div>
                    <h2 class="text-lg font-bold bg-gray-300 w-full pl-4 pr-2 pt-1 rounded-t-md flex justify-between">
                    ...
                    <x-measures-protection wire:model="personalProtection" />
                </div>
            </div>
