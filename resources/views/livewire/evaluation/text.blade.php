    ...
    <div>
        <div class="grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 gap-4 m-auto p-2">
            ...
            <div>
                <div class="mb-2 border border-gray-100 rounded-lg bg-gray-100 focus-within:bg-green-500 focus-within:border-green-500 ease-in duration-300">
                    ...
                    <div class="px-4 py-2 bg-white rounded-b-lg">
                        <textarea wire:model="danger" id="" rows="5" class="resize-none block w-full px-0 text-sm text-gray-800 bg-white border-0 focus:ring-0" placeholder="write your thoughts here..." ></textarea>
                    </div>
                </div>
            ...
            <DIV>
                <div class="mb-2 border h-fit border-gray-100 rounded-lg bg-gray-100 focus-within:bg-green-500 focus-within:border-green-500 ease-in duration-300">
                    ...
                    <div class="px-4 py-2  bg-white rounded-b-lg">
                        <textarea wire:model.defer="possibleEffects" id="" rows="5" class="resize-none block w-full px-0 text-sm text-gray-800 bg-white border-0 focus:ring-0" placeholder="write your thoughts here..."></textarea>
                    </div>
                </div>
                @error('possibleEffects') <span class="error text-red-500">{{ $message }}</span> @enderror
            </DIV>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 gap-4 m-auto">
            ...
            <div class="m-2 border border-gray-100 rounded-lg bg-gray-100 focus-within:bg-green-500 focus-within:border-green-500 ease-in duration-300">
                ...
                <div class="px-4 py-2 bg-white rounded-b-lg">
                    <textarea id="" rows="5" class="resize-none block w-full px-0 text-sm text-gray-800 bg-white border-0 focus:ring-0" placeholder="write your thoughts here..."></textarea>
                </div>
            </div>
