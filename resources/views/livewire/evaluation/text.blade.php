<div>
    ...
    <div>
        <div class="grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 gap-4 m-auto p-2">
            <livewire:evaluation.text.danger />
            <livewire:evaluation.text.possible-effects />
        </div>
        <div class="flex justify-center">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 gap-4 m-auto">
            <livewire:evaluation.text.source />
            <livewire:evaluation.text.means />
            <livewire:evaluation.text.individual />
        </div>
    </div>
</div>
