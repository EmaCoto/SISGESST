    ...
    <x-content-block>
        <form wire:submit.prevent="save">
            ...
            <div class="flex justify-center m-auto mt-10 w-full">
                <button type="submit" wire:loading.remove class="relative inline-flex items-center justify-center px-10 py-3 overflow-hidden active:text-blue-300 font-mono font-medium tracking-tighter text-white bg-gray-800 rounded-lg group">
