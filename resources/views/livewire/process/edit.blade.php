...
<div>
    <button href="{{ route('process.edit', $processes) }}" class="mx-2 p-1 rounded-lg flex items-center bg-blue-500 text-white hover:bg-blue-800 hover:text-white" wire:click="$set('open', 'false')">
