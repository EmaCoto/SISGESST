<div class="mb-24">
    ...
    <div class="border rounded-lg overflow-hidden">
        <div class="flex h-36 bg-gray-200 group hover:h-72 ease-in-out overflow-hidden duration-700">
            <img src="{{ asset('img/table.jpg') }}" alt="" class="w-1/3 ease-in-out duration-700">
            <div class="p-5">
                <h1 class="text-sm sm:text-base md:text-lg font-semibold">Lorem ipsum dolor sit amet.</h1>
                <p class="text-justify text-sm sm:text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti nostrum omnis magnam beatae voluptatum minima nemo ullam! Provident nostrum id, in tenetur quae commodi fuga maiores quos illo, nesciunt temporibus!</p>
                <p class="opacity-0 group-hover:opacity-100 text-justify text-sm sm:text-lg">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sequi laboriosam asperiores iure quas numquam accusamus, fuga tenetur nostrum. Blanditiis, non porro laborum doloremque ab iste recusandae provident nulla maxime excepturi! <br>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit quidem culpa deserunt voluptatum suscipit dolores vel iusto, nulla voluptatem nesciunt architecto consectetur. Tenetur dolorem tempora, error aliquam animi enim quam.</p>
            </div>
        </div>
        <div class="flex h-36 group hover:h-72 ease-in-out overflow-hidden duration-700">
            ...
            <img src="{{ asset('img/like.jpg') }}" alt="" class="w-1/3 ease-in-out duration-700">
        </div>
        ...
        <div class="flex h-36 group hover:h-72 overflow-hidden ease-in-out duration-700">
            ...
            <img src="{{ asset('img/comosaber.jpg') }}" alt="" class="w-1/3 ease-in-out duration-700">
        </div>
    </div>
</div>
